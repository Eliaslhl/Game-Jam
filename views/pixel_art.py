...
ART = {
'player': ['...oooo...', '..owwwwo..', '..owswwo..', '...oswo...', '..obbbbo..', '.obbbbbbo.', '.owbbbbwo.', '..oBBBBo..', '..oBooBo..', '..os..so..', '.ooo..ooo.'],
...
class PixelTiles:
        ...
        for y,row in enumerate(level.grid):
            for x,tile in enumerate(row):
                ...
                if tile=='#':
                    ...
                    base=(26+variation,33+variation,39+variation)
                    pygame.draw.rect(self.surface,base,rect)
                    pygame.draw.line(self.surface,(18,25,30),rect.topleft,rect.topright)
                    pygame.draw.line(self.surface,(19,25,31),rect.topleft,rect.bottomleft)
                    pygame.draw.line(self.surface,(37,44,49),(rect.x+2,rect.y+14),(rect.x+12,rect.y+14))
                    if rng.random()<.13:
                        pygame.draw.line(self.surface,(19,26,33),(rect.x+5,rect.y+2),(rect.x+8,rect.y+7))
                    if tile=='.' and rng.random()<.08:
    ...
    def wall(self,rect,rng):
        ...
        pygame.draw.rect(self.surface,(57+shade,65+shade,76+shade),(x,y,15,15))
        pygame.draw.line(self.surface,(92+shade,101+shade,109+shade),(x+1,y),(x+13,y))
        pygame.draw.line(self.surface,(76,84,94),(x,y+1),(x,y+12))
        pygame.draw.line(self.surface,(23,30,42),(x+1,y+14),(x+14,y+14))
        pygame.draw.line(self.surface,(31,39,51),(x+14,y+1),(x+14,y+14))
        if rng.random()<.4:
            pygame.draw.lines(self.surface,(35,43,55),False,[(x+9,y+2),(x+6,y+6),(x+8,y+9)])
        if rng.random()<.24:
            for _ in range(5):
